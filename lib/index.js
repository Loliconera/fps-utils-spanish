		...
		switch (page) {
			...
			default:
				gui.parse([
					...
					{ text: `<font color="${Cfg.HideMonsterDeathAnimation ? GrnC : RedC}" size="+18">[Ocultar Animación de Muerte de Monstruo]</font>`, command: "fps monsterdeathani;fps gui" }, { text: "&nbsp;&nbsp;" },
					{ text: `<font color="${Cfg.ActionScripts ? GrnC : RedC}" size="+18">[Zoom]</font>`, command: "fps npczoom;fps gui" }, { text: "&nbsp;&nbsp;" },
